    ...
    >
      ...
      <div className="relative container mx-auto px-6 md:px-12 lg:px-20 pt-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Main Heading */}
          <h1 className="reveal opacity-0 font-serif text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-medium leading-tight mb-8" style={{ animationDelay: "0.2s" }}>
            Transformez votre{" "}
          ...
          {/* Subtitle */}
          <p className="reveal opacity-0 text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed" style={{ animationDelay: "0.4s" }}>
          ...
          {/* CTA Buttons */}
          <div className="reveal opacity-0 flex flex-col sm:flex-row items-center justify-center gap-4" style={{ animationDelay: "0.6s" }}>
          ...
          {/* Stats */}
          <div className="reveal opacity-0 mt-20 grid grid-cols-3 gap-8 max-w-2xl mx-auto" style={{ animationDelay: "0.8s" }}>
            {[
